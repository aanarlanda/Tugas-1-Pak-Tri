package ac.id.atmaluhur.a1711500080travelaan;
...
public class RegisterAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editor.putString(username_key,username.getText().toString()); //ngambil data inputan username disimpan ke variabel u
        editor.apply();
